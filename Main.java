  ...
  public static void main(String[] args){
    ...
    if(argc == 1){
      ...
      if(args[0].equals("help")){
        ...
        System.out.println(mvto.listAlias(mvto.getPathFileConfig()));

      }else{
        
        String path = mvto.pathAlias(mvto.getPathFileConfig(), args[0]);
        if(path == null){
    ...
    if(argc == 2){
      ...
      if(args[0].equals("rmv") && args[1] != null){

        boolean result = mvto.rmvAlias(mvto.getPathFileConfig(), args[1]);
        ...
        String path = mvto.pathAlias(mvto.getPathFileConfig(),args[1]);
